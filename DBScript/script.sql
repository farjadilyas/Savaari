...
(
     ...
     `MULTIPLIER` DECIMAL(2,2) UNSIGNED NOT NULL,
...
(
     ...
     `DRIVER_ID` INT(10) UNSIGNED NOT NULL,
     `PAYMENT_ID` INT(10) UNSIGNED NOT NULL UNIQUE,
...
SET IS_ACTIVE = 0, RIDE_STATUS = 0, RIDER_ID = -1, DEST_LAT = 0, DEST_LONG = 0;
