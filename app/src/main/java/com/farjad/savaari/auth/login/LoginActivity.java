...
import com.farjad.savaari.auth.biometric.BiometricCallback;
import com.farjad.savaari.auth.biometric.BiometricCallbackV28;
import com.farjad.savaari.auth.signup.SignUpActivity;
...
public class LoginActivity extends AppCompatActivity implements BiometricCallback {
    ...
    private void init() {
        loginViewModel = ViewModelProviders.of(this,
                new LoginViewModelFactory(Util.getInstance().getRepository()))
